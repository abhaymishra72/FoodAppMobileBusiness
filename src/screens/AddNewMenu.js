      ...
      try {
        axios
          ...
          .then((response) => {
            ...
            foodCategoryMap = response.data.map((item, i) => {
              return (
                <Picker.Item
                  key={i}
...
//   }
  const addCategoryButton = async () => {
      ...
      try {
        ...
        await axios
          ...
          .then((response) => {
            ...
            Alert.alert("Success", response.data.id);
            console.log("line 180", response.data.id);
            categoryiddata=response.data.id;
            setcategoryId(response.data.id);
            console.log(response.data.id, "line 203");            
          })
    ...
    console.log("category id", categoryiddata);
  };
